...
using DAL;
using ASPCoreAngular4.ViewModels;
using AutoMapper;
using DAL.Models;
using Microsoft.Extensions.Logging;
using ASPCoreAngular4.Helpers;

namespace ASPCoreAngular4.Controllers
{
    ...
    public class CustomerController : Controller
    {
        ...
        public async Task<string> Email()
        {
            ...
            (bool success, string errorMsg) response = await EmailSender.SendEmailAsync(recepientName, recepientEmail, "Test Email from ASPCoreAngular4", message);
